...
FUNCTION_PATTERNS = {
    ...
    r'^set_assignment_': "Sets assignment dates for",
    r'^process_csv': "Processes CSV files for",
    r'^login_': "Handles login to",
...
MODULE_NAME_HINTS = {
    ...
    'd2l': "D2L (Desire2Learn) course management automation",
    'date_processing': "Date processing and automation",
    'playwright_processor': "Playwright-based browser automation",
